...
import static utils.BankUtils.nextConfirm;
...
public class AccountService {
	...
	public void open() {
		...
		accounts.add(new Account(no, CustomerService.getInstance().getLoginCustomer(), nextLine("비밀번호")));
	}
	...
	public void close() {
		...
		if(!nextConfirm("해지하세겠습니까?(남은 잔고는 사라집니다)")) {
			return;
